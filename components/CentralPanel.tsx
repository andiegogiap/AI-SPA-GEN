...
const CommitModal: React.FC<{ onCommit: (message: string) => void; onClose: () => void; }> = ({ onCommit, onClose }) => {
    ...
    return (
        <div className="absolute inset-0 bg-black/80 flex items-center justify-center z-50">
            <div className="bg-neon-panel backdrop-blur-lg border border-neon-purple rounded-lg p-6 w-full max-w-md shadow-lg shadow-neon-purple/20">
...
const CentralPanel: React.FC<CentralPanelProps> = (props) => {
  ...
  return (
    <section className="bg-neon-panel backdrop-blur-xl border border-neon-border rounded-lg p-2.5 flex flex-col gap-2.5 min-w-0">
