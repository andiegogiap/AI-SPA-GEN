...
const QuickNav: React.FC<QuickNavProps> = (props) => {
  ...
  return (
    <div ref={wrapperRef} className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="absolute bottom-full right-0 mb-3 w-64 bg-neon-panel/90 backdrop-blur-xl border border-neon-border rounded-lg shadow-lg shadow-neon-purple/20 overflow-hidden">
